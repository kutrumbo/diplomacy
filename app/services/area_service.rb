module AreaService
  def self.seed_areas
    # Create Areas
    Area.create!(name: 'Ankara', type: 'land', supply_center: true)
    Area.create!(name: 'Belgium', type: 'land', supply_center: true)
    Area.create!(name: 'Berlin', type: 'land', supply_center: true)
    Area.create!(name: 'Brest', type: 'land', supply_center: true)
    Area.create!(name: 'Budapest', type: 'land', supply_center: true)
    Area.create!(name: 'Bulgaria', type: 'land', supply_center: true)
    Area.create!(name: 'Constantinople', type: 'land', supply_center: true)
    Area.create!(name: 'Denmark', type: 'land', supply_center: true)
    Area.create!(name: 'Edinburgh', type: 'land', supply_center: true)
    Area.create!(name: 'Greece', type: 'land', supply_center: true)
    Area.create!(name: 'Holland', type: 'land', supply_center: true)
    Area.create!(name: 'Kiel', type: 'land', supply_center: true)
    Area.create!(name: 'Liverpool', type: 'land', supply_center: true)
    Area.create!(name: 'London', type: 'land', supply_center: true)
    Area.create!(name: 'Marseilles', type: 'land', supply_center: true)
    Area.create!(name: 'Moscow', type: 'land', supply_center: true)
    Area.create!(name: 'Munich', type: 'land', supply_center: true)
    Area.create!(name: 'Naples', type: 'land', supply_center: true)
    Area.create!(name: 'Norway', type: 'land', supply_center: true)
    Area.create!(name: 'Paris', type: 'land', supply_center: true)
    Area.create!(name: 'Portugal', type: 'land', supply_center: true)
    Area.create!(name: 'Rome', type: 'land', supply_center: true)
    Area.create!(name: 'Rumania', type: 'land', supply_center: true)
    Area.create!(name: 'Saint Petersburg', type: 'land', supply_center: true)
    Area.create!(name: 'Serbia', type: 'land', supply_center: true)
    Area.create!(name: 'Sevastopol', type: 'land', supply_center: true)
    Area.create!(name: 'Smyrna', type: 'land', supply_center: true)
    Area.create!(name: 'Spain', type: 'land', supply_center: true)
    Area.create!(name: 'Sweden', type: 'land', supply_center: true)
    Area.create!(name: 'Trieste', type: 'land', supply_center: true)
    Area.create!(name: 'Tunis', type: 'land', supply_center: true)
    Area.create!(name: 'Venice', type: 'land', supply_center: true)
    Area.create!(name: 'Vienna', type: 'land', supply_center: true)
    Area.create!(name: 'Warsaw', type: 'land', supply_center: true)
